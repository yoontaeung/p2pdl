...
def load_mizu_data(num_clients, batch_size=32):
    ...
    split_sizes[-1] += total_length - sum(split_sizes)  
...
def load_data(num_clients, dataset_name='CIFAR10', batch_size=32):
    ...
    ## TODO: WIP
    elif dataset_name == 'MIZU':
        return load_mizu_data(num_clients, batch_size)
    else:
